...
See [docs/build.md](docs/build.md) for details on the build process, firmware handling, TrueNAS-specific constraints, automated update checks, and custom builds.
